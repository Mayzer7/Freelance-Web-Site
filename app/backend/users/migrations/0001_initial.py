# Generated by Django 5.0.2 on 2025-03-28 18:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience_level', models.CharField(choices=[('beginner', 'Начинающий'), ('intermediate', 'Средний уровень'), ('expert', 'Эксперт')], default='beginner', max_length=20)),
                ...
                ('preferred_work_hours', models.JSONField(blank=True, default=dict)),
